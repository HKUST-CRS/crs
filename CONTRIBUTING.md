...
- Make PR for draft changes. Squash merge it when ready.
  - This helps keep the commit history clean and focused on the final changes.
  - It is also better to seek for approvals from code reviews before merging.
