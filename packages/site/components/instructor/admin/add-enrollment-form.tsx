...
function parse(input: string) {
  ...
  const successEmails = successes.map(([email]) => email);
  const successMessages = successes.map(([, msg]) => msg);
      ...
      <Controller
        ...
        render={({ field, fieldState }) => (
          <Field>
            ...
            />
            <FieldDescription>
              The emails of the users to be enrolled. One email per line.
            </FieldDescription>
