        ...
        render={({ field, fieldState }) => (
          <Field>
            ...
            <Select value={field.value ?? ""} onValueChange={field.onChange}>
              ...
              <SelectContent>
                {(["open", "closed", "graded"] as const).map((state) => (
            ...
            <FieldDescription>
              Must be "graded" for students to open appeals for this assignment.
            </FieldDescription>
            <FieldError errors={[fieldState.error]} />
          </Field>
        )}
      ...
      <Controller
        ...
        render={({ field, fieldState }) => (
          <Field>
            ...
            <Textarea
              placeholder={"ta1@ust.hk\nta2@ust.hk\n"}
              rows={3}
              {...field}
            />
            <FieldDescription>
              One email per line. These TAs can view and reply to appeals for
              this assignment.
            </FieldDescription>
            <FieldError errors={[fieldState.error]} />
          </Field>
